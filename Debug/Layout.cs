// -----------------------------------------------------------------------
// <copyright file="Layout.cs" company="Mort8088 Games">
...
namespace SystemX.Debug {
    ...
    public struct Layout {
        ...
        /// </summary>
        /// <param name="size">placing region</param>
        /// <param name="horizontalMargin"></param>
        /// <param name="verticalMargine"></param>
        ...
        public Rectangle Place(Rectangle region, float horizontalMargin, float verticalMargine, Alignment alignment) {
            // Horizontal layout.
            if ((alignment & Alignment.Left) != 0) region.X = ClientArea.X + (int)(ClientArea.Width * horizontalMargin);
            ...
            // Vertical layout.
            if ((alignment & Alignment.Top) != 0) region.Y = ClientArea.Y + (int)(ClientArea.Height * verticalMargine);
